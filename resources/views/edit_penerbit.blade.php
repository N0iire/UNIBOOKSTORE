        ...
        <div class="w-full max-w-md bg-white rounded-lg shadow-lg py-8 px-8">
            ...
            <form action="/penerbit/update/{{ $penerbit->id }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input class="w-full border border-gray-400 p-2 rounded-lg" type="text" id="id" value="{{ $penerbit->id_penerbit }}" name="id_penerbit" required>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input class="w-full border border-gray-400 p-2  rounded-lg" value="{{ $penerbit->alamat }}" type="text" id="alamat"
                        name="alamat" required>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 font-medium mb-2" for="kota">Kota</label>
                    <input class="w-full border border-gray-400 p-2 rounded-lg" type="text" value="{{ $penerbit->kota }}" id="kota"
                        name="kota" required>
                </div>
                <div class="mb-4">
