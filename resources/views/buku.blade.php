        ...
        <div class="w-full max-w-md bg-white rounded-lg shadow-lg py-8 px-8">
            ...
            <form action="tambah/" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input class="w-full border border-gray-400 p-2 rounded-lg" type="text" id="id" name="id_buku" required>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input class="w-full border border-gray-400 p-2 rounded-lg" type="text" id="namaBuku"
                        name="nama_buku" required>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <select class="w-full border border-gray-400 p-2 rounded-lg" id="penerbit" name="penerbit" required>
